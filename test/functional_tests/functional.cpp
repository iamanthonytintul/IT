...
public:
    ...
    boolean (*print_the_most_aged_employees_in_each_position)(FILE *input_stream, employee_info **emp,
                                                              int capacity_of_emp);
...
protected:
    void SetUp() {
        ...
        *(void **) (&dyn_lib->print_the_most_aged_employees_in_each_position) =
                dlsym(dyn_lib->library, "print_the_most_aged_employees_in_each_position");
...
TEST_F(Functional_test, HandlesFirstRegularCase) {
    ...
    if (capacity_of_employees != FAILURE) {
        ...
        if (employees) {
            ...
            dyn_lib->print_the_most_aged_employees_in_each_position(output_dynamic_stream, employees,
...
TEST_F(Functional_test, HandlesSecondRegularCase) {
    ...
    if (capacity_of_employees != FAILURE) {
        ...
        if (employees) {
            dyn_lib->sort_by_surname(employees, capacity_of_employees);
            dyn_lib->print_the_most_aged_employees_in_each_position(output_dynamic_stream, employees, capacity_of_employees);
        }
        dyn_lib->free_employees(employees, capacity_of_employees);
    }
