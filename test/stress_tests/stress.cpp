...
TEST_F(Stress_test, HandlesHundredThousandCase) {
    ...
    FILE *input_stream = fopen(PATH_STRESS_INPUT_HUNDRED_THOUSAND_CASE, "r");
    FILE *output_static_stream = fopen(PATH_STRESS_OUTPUT_STATIC_LIB, "w+");
    FILE *output_dynamic_stream = fopen(PATH_STRESS_OUTPUT_DYNAMIC_LIB, "w+");
...
TEST_F(Stress_test, HandlesFiveHundredCase) {
    ...
    FILE *input_stream = fopen(PATH_STRESS_INPUT_FIVE_HUNDRED_THOUSAND_CASE, "r");
    FILE *output_static_stream = fopen(PATH_STRESS_OUTPUT_STATIC_LIB, "w+");
    FILE *output_dynamic_stream = fopen(PATH_STRESS_OUTPUT_DYNAMIC_LIB, "w+");
